...
function renderSourceList() {
    ...
    sourcesData.forEach(src => {
        ...
        tr.innerHTML = `
            ...
            <td class="thumb-col" style="width:88px; padding:5px 10px; box-sizing:border-box;">${thumbHtml}</td>
